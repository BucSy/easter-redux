...
import { styles } from '../../../containers/FavouritesStyle/FavouriteListStyle';

interface FavouriteListComponentProps {
    data: dataState;
    deleteFavData: typeof deleteFavData;
}

class FavouriteListComponent extends Component<FavouriteListComponentProps> {
...
export default connect(mapStateToProps, { getFavData, deleteFavData })(FavouriteListComponent);